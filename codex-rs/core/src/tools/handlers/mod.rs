...
mod request_plugin_install_legacy;
...
pub use request_plugin_install::RequestPluginInstallsHandler;
pub use request_plugin_install_legacy::RequestPluginInstallHandler;
